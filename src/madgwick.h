...
// values
#ifndef DELTA_T
#define DELTA_T 0.001f // 1kHz sampling frequency
#define DELTA_T_US (int64_t)1000
#endif
...
#define GYRO_MEAN_ERROR                                                                            \
  PI * (5.0f / 180.0f) // 5 deg/s gyroscope measurement error (in rad/s)  *from paper*
#endif
...
// the norm is also the sqrt(q * conjugate(q)), but thats a lot of operations in
